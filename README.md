...
| PolygonAreaCalculator | A "Category" class that can be used to create different budget categories.| [PolygonAreaCalculator](https://github.com/ronanren/Challenges/blob/master/Scientific-Computing-with-Python/PolygonAreaCalculator)
